...
namespace Memberships.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        {
            // modification made to use ProductModel instead of the original Product
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Title,ImageUrl,Description,ProductLinkTextId,ProductTypeId")] Product product)
        {
            if (ModelState.IsValid)
            {
